...
export default props => (
  <div>
    ...
    <CardGroup className="mb-4">
      ...
      <Widget02 header="Documents" mainText="upload" icon="icon-cloud-upload" color="info" variant="1"/>
      <Widget02 header="Results" mainText="skip to" icon="icon-book-open" color="primary" variant="1"/>
      <Widget02 header="Trainer" mainText="Re-assign to" icon="icon-link" color="danger" variant="1"/>
      <Widget02 header="Case Files" mainText="skip to" icon="icon-layers" color="primary" variant="1"/>
      <Widget02 header="Case File" mainText="create" icon="icon-plus" color="teal" variant="1"/>
